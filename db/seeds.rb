...
tricepkickback = Exercise.create(title: 'tricep kickbacks', recommended_reps: '5 x 10', equipment: 'dumbbells')
...
kneelpushup = Exercise.create(title: 'kneeling pushups', recommended_reps: '3 x 10')
